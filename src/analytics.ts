...
type Event = 'open-the-app'
  ...
  | 'tab-bar/press-wallets-menu'
  | 'tab-bar/press-account-menu'
  | 'wallets/pull-the-screen-to-reload'
  | 'wallets/press-deposit-from-welcome-message'
  | 'wallets/press-deposit-button'
  | 'wallets/press-withdraw-button'
  | 'wallets/press-transfer-button'
  | 'wallets/press-trade-button'
  | 'wallets/press-deposit-button-on-tranfer-modal'
  | 'wallets/press-withdraw-button-on-tranfer-modal'
  | 'wallets/press-outside-tranfer-modal'
  | 'wallets/close-asset-card'
  | 'wallets/open-asset-card'
